...
pub contract CryptoPoops: NonFungibleToken {
  ...
  pub  resource interface MyAuthCollection {
  ...
  pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MyAuthCollection {
    ...
    // pub fun borrowAuthNFT(id: UInt64): &NonFungibleToken.NFT {
      //let authNFT = (&self.ownedNFTs[id] as auth  &NonFungibleToken.NFT?)!
      //return authNFT as! &NFT
    //}
